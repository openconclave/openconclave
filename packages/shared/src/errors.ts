export const ErrorCode = {
  ...
  // Conclave
  CONCLAVE_NOT_FOUND: "CONCLAVE_NOT_FOUND",
  CONCLAVE_DISABLED: "CONCLAVE_DISABLED",
  CONCLAVE_CYCLE_DETECTED: "CONCLAVE_CYCLE_DETECTED",
  CONCLAVE_MAX_ITERATIONS: "CONCLAVE_MAX_ITERATIONS",
  CONCLAVE_NO_ENTRY: "CONCLAVE_NO_ENTRY",
  CONCLAVE_MERGE_DEADLOCK: "CONCLAVE_MERGE_DEADLOCK",
